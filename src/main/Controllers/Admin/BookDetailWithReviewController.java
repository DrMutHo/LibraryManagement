...
public class BookDetailWithReviewController {
     ...
     * Customizes the table cells to display stars for ratings and uses TextFlow for long comments.
     */
    private void loadReviews() {
        ...
        // Customize the cell factory for the comment column to handle long comments using TextFlow
