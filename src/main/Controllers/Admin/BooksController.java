...
public class BooksController implements Initializable{
    ...
    public void initialize(URL url, ResourceBundle resource){
        ...
        String viewquery = "SELECT book_id, title, author, isbn, genre, language, description, publication_year, image_url FROM book";
        ...
        try {
            ...
            while(queryout.next()){
                ...
                booklists.add(new booksearch(queryid, querytitle, queyauthor, queryisbn, querygenre, querylan, querydes, queryyear, queryurl));
                ...
                publication_year.setCellValueFactory(new PropertyValueFactory<>("publication_year"));
