    ...
    public class AddBookController {
        ...
        @FXML private TextField searchEdt;
        @FXML private Button searchBtn;
        @FXML private VBox bookContainer; // VBox to hold search results
            ...
            try {
                ...
                if (books.isEmpty()) {
                    ...
                    for (Book book : books) {
                        ...
                        FXMLLoader loader = new FXMLLoader(getClass().getResource("/resources/Fxml/Admin/HboxBookCard.fxml"));
