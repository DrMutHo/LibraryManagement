...
public class GoogleBooksAPI {
    ...
    public static List<Book> ParseData(String query) {
        ...
        try {
            ...
            for (int i = 0; i < itemsArray.size(); i++) {
                ...
                // Create Book object with default values for book_id, average_rating, and
                // review_count
                Book bookInfo = new Book(0, title, authors, isbn, genre, language, description, publicationYear,
                        imageUrl, 0, 0, 0);
    ...
    // Helper method to extract the publication year from a date string (e.g.,
    // "2020-01-01")
